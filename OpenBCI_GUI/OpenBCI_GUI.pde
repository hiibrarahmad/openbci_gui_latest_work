...
String localGUIVersionDate = "2025/03/31 15:02:06";
...
final int DATASOURCE_NEURO11 = 6;  // Cyton-compatible UDP packets from Neuro11 tunnel
...
void initSystem() {
    ...
    switch (eegDataSource) {
        ...
        case DATASOURCE_STREAMING:
            ...
            break;
        case DATASOURCE_NEURO11:
            currentBoard = new BoardNeuro11UDP(
                    controlPanel.streamingBoardBox.getIP(),
                    controlPanel.streamingBoardBox.getPort()
                    );
            println("OpenBCI_GUI: Init session using Open Neuro11 UDP data source");
            break;
        default:
            break;
    }
    ...
    if (eegDataSource != DATASOURCE_STREAMING && eegDataSource != DATASOURCE_NEURO11) {
